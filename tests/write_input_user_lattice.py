...
# Assertion:
f = open("lattice_input.dat", "r")
f_original = open("original_inputs/user_lattice/lattice_input.dat", "r")
try:
    assert (f.read() == f_original.read())
    print("File lattice_input.dat using user-defined lattice, \
successfully written.\n")
except Exception:
    print("Test on file lattice_input.dat not passed.")
    raise
