...
"""
    ...
    job0.results.plot_process_statistics(
        process_statistics0[n - 1], key="occurence_frequency", log_scale=True, pause=2, close=True
    )
    job2.results.plot_process_statistics(
        process_statistics2[n - 1], key="occurence_frequency", log_scale=True, pause=2, close=True
    )
