...
#job_ads = scm.plams.AMSJob.load_external( path="plams_workdir.ok/CO_ads+Pt111" )
#results_ads = job_ads.results
#job_bs = scm.plams.AMSJob.load_external( path="plams_workdir.ok/CO_bs+Pt111" )
#results_bs = job_bs.results
