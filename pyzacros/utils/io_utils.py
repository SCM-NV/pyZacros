...
def read_input_data( engine: str, electronic_package: str = None, path: str = None):
    """
    ...
    :return: instantiation of PLAMS-like settings according for the input files read.  
    """
