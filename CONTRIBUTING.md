...
* Create a topic branch from where you want to base your work.
  * This is usually the trunk branch.
  * Only target release branches if you are certain your fix must be on that
    branch.
  * To quickly create a topic branch based on trunk; `git checkout -b
    fix/trunk/my_contribution trunk`. Please avoid working directly on the
    `trunk` branch.
